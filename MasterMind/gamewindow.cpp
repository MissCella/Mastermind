        ...
        if (resultado[0] == 2 && resultado[1] == 2 && resultado[2] == 2 && resultado[3]){
            ...
            if(!arrayintento[0].empty()){
                ...
                if (resultado[0] == 2){
                    ...
                    labelCalificacion->setStyleSheet("image: url(:/images/images/ball_black.png);");
                    labelCalificacion->setGeometry(calificacionX, calificacionY, 41,21);
                    labelCalificacion->show();
                }else{
                    labelCalificacion = new QLabel(this);
                    labelCalificacion->setStyleSheet("image: url(:/images/images/ball_white.png);");
                    labelCalificacion->setGeometry(calificacionX, calificacionY, 41,21);
                    labelCalificacion->show();
                }
                ...
                if (resultado[1] == 2){
                    ...
                    labelCalificacion2->setStyleSheet("image: url(:/images/images/ball_black.png);");
                    labelCalificacion2->setGeometry(calificacionX+30, calificacionY, 41,21);
                    labelCalificacion2->show();
                }else{
                    labelCalificacion2 = new QLabel(this);
                    labelCalificacion2->setStyleSheet("image: url(:/images/images/ball_white.png);");
                    labelCalificacion2->setGeometry(calificacionX+30, calificacionY, 41,21);
                    labelCalificacion2->show();
                }
                if (resultado[2] == 2){
                    labelCalificacion3 = new QLabel(this);
                    labelCalificacion3->setStyleSheet("image: url(:/images/images/ball_black.png);");
                    labelCalificacion3->setGeometry(calificacionX, calificacionY+30, 41,21);
                    labelCalificacion3->show();
                }else {
                    labelCalificacion3 = new QLabel(this);
                    labelCalificacion3->setStyleSheet("image: url(:/images/images/ball_white.png);");
                    labelCalificacion3->setGeometry(calificacionX, calificacionY+30, 41,21);
                    labelCalificacion3->show();
                }
                if (resultado[3] == 2){
                    labelCalificacion4 = new QLabel(this);
                    labelCalificacion4->setStyleSheet("image: url(:/images/images/ball_black.png);");
                    labelCalificacion4->setGeometry(calificacionX+30, calificacionY+30, 41,21);
                    labelCalificacion4->show();
                }else{
                    labelCalificacion4 = new QLabel(this);
                    labelCalificacion4->setStyleSheet("image: url(:/images/images/ball_white.png);");
                    labelCalificacion4->setGeometry(calificacionX+30, calificacionY+30, 41,21);
                    labelCalificacion4->show();
                }
...
void GameWindow::on_deshacer_clicked()
{
    ...
    ui->bton1->setStyleSheet("border-image: url(:/images/images/ball_"+QString::fromStdString(playStack[0][0])+".png);");
    ui->bton2->setStyleSheet("border-image: url(:/images/images/ball_"+QString::fromStdString(playStack[0][1])+".png);");
    ui->bton3->setStyleSheet("border-image: url(:/images/images/ball_"+QString::fromStdString(playStack[0][2])+".png);");
    ui->bton4->setStyleSheet("border-image: url(:/images/images/ball_"+QString::fromStdString(playStack[0][3])+".png);");
